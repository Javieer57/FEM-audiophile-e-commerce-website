...
export function Footer() {
  return (
    <footer className="bg-dark text-white">
      <div className="relative mx-auto flex max-w-289 flex-col gap-12 px-6 pt-13 pb-10 md:gap-8 md:px-10 md:pt-15 md:pb-11.5 lg:gap-9 lg:px-6 lg:pt-19 lg:pb-12">
