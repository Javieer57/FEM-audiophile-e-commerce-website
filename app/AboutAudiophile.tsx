export function AboutAudiophile() {
  return (
    <section aria-labelledby="about-title" className="general-container">
      <div className="grid items-center gap-10 md:gap-16 lg:grid-cols-2 lg:gap-32">
        <div className="space-y-8 max-lg:order-2 max-lg:text-center md:max-lg:mx-auto md:max-lg:max-w-11/12">
          <h2
            id="about-title"
          ...
          <p className="font-medium text-balance opacity-50">
